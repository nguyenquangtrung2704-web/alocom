...
with tab3:
    ...
    if not rows:
        ...
        if mode == "Theo tháng":
            ...
            # ---------------- QR CHUYỂN KHOẢN - NHÚNG TRỰC TIẾP NHƯ BANNER ----------------
            st.markdown(
                """
                <style>
                .bank-qr-wrap {
                ...
                .bank-qr-card {
                    ...
                    background:
                        radial-gradient(circle at 100% 0%, rgba(237,28,36,.08), transparent 34%),
                        linear-gradient(180deg, #fffdfd 0%, #fff7f7 100%);
                    box-shadow: 0 12px 34px rgba(122, 38, 45, 0.10);
                    text-align: center;
                }
                ...
                @media (prefers-color-scheme: dark) {
                    .bank-qr-card {
                        background:
                            radial-gradient(circle at 100% 0%, rgba(237,28,36,.14), transparent 34%),
                            linear-gradient(180deg, #1f1f23 0%, #28282d 100%);
                ...
                <div class="bank-qr-wrap">
                    <div class="bank-qr-card">
                        <div class="bank-qr-title">TECHCOMBANK – QUÉT MÃ ĐỂ THANH TOÁN</div>
                        <img
                            class="bank-qr-image"
                        ...
                        >
                        <div class="bank-qr-action">📱 Quét mã để chuyển khoản</div>
                        <div class="bank-qr-note">
                            Sau khi chuyển khoản, vui lòng chờ quản trị viên xác nhận.
                            Trạng thái thanh toán sẽ được cập nhật trong bảng bên dưới.
                        </div>
                    </div>
                </div>
                """,
